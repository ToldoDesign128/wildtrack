...
<section class="hero-page">
    <div class="container-fluid">
        ...
        <div class="row">
            <h4 class="col-12 col-lg-8 offset-lg-1">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. TRENTINO</h4>
        </div>
        <div class="row">
