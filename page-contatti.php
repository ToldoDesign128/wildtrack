...
<section class="hero-page">
    <div class="container">
        ...
        <div class="row">
            <h4 class="col-lg-8">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. TRENTINO</h4>
        </div>
        <div class="row">
            <div class="col-lg-2">
