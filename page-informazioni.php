...
<section class="content">
    ...
    <div class="container banner"><!--blocco 2-->
        <div class="row">
            ...
            <div class="col">
                <div class="row">
                    <h2>Matteo Avancini</h2>
                </div>
                <div class="row">
                    <p>Nato nel 1990 a Trento e cresciuto a Levico Terme. Da sempre appassionato di sport outdoor e ha iniziato a portare avanti le mie passioni divenute poi professioni: maestro di sci d’inverno dal 2014 ed accompagnatore di Media Montagna Trentino l’estate dal 2018. <br><br> Perché scegliere un AMMT?</p>
                </div>
                <div class="row">
                    <div class="col">
                        <img src="" alt="">
