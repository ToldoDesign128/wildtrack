...
<section class="hero">
    <div class="container">
        <div class="row">
            <h1>Mountain hiking <br> & Nature experience</h1>
        </div>
        <div class="row">
            <div class="col-2">
...
<section class="carousel">
    <div class="container">
        <div class="row">
            <h2 class="col">TUTTE LE PROPOSTE <br>DA PERCORRERE assiemE</h2>
            <a href="">
                <button class="col">Escursioni</button>
            </a>
        </div>
    </div>
...
<!-- Poster block-->
<section class="block"> <!-- blocco 1-->
    <div class="row">
        <div class="col image"></div>

        <div class="col">
            <div class="row">
                <h2>ALLA SCOPERTA <br> DELLA STORIA</h2>
            </div>
            <div class="row">
                <a href="">
...
<section class="block"> <!-- blocco 2-->
    <div class="row">
        <div class="col image"></div>

        <div class="col">
            <div class="row">
                <h2>IL PROGETTO <br>WILDTRACK</h2>
            </div>
            <div class="row">
                <a href="">
...
<section class="block"> <!-- blocco 3-->
    <div class="row">
        <div class="col">
            <div class="row">
                <h2>PERCHè scegliere <br>Un AMMT?</h2>
            </div>
            <div class="row">
                <a href="">
