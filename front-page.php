...
<section class="carousel">
    <div class="container">
        <div class="row">
            <h2 class="col-lg-8">TUTTE LE PROPOSTE <br>DA PERCORRERE assiemE</h2>
            <a href="" class="col-lg-3 offset-lg-1">
...
<section class="block"> <!-- blocco 1-->
    <div class="row">
        ...
        <div class="col-lg-7">
            <div class="row">
                <h2 class="col-lg-10">ALLA SCOPERTA <br> DELLA STORIA</h2>
            </div>
            <div class="row">
                <a href="" class="">
...
<section class="block"> <!-- blocco 3-->
    <div class="row">
        <div class="col-lg-7">
            <div class="row">
                <h2 class="col-lg-8 offset-lg-2">PERCHè scegliere <br>Un AMMT?</h2>
            </div>
            <div class="row">
                <a href="" class="offset-lg-2">
                    <button>Escursioni</button>
                </a>
            </div>
        </div>
